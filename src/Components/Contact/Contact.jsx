	...
	return (
		<div className="container">
			...
			<div className="contact-container">
				<a
					className="contact-press-container"
					href="https://www.linkedin.com/in/imran-ilyas"
					target="_blank"
					rel="noreferrer"
				>
				...
				<a
					className="contact-press-container"
					href="https://github.com/imranilyas"
					target="_blank"
					rel="noreferrer"
				>
				...
				<div className="contact-container">
					...
					<div className="whole-contact-icon">
						...
						<a
							...
							href="mailto: imranilyas2416@gmail.com"
						>
							imranilyas2416@gmail.com
						</a>
					</div>
					<div className="whole-contact-icon">
